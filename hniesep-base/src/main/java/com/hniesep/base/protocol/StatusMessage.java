...
public class StatusMessage {
    ...
    public static final String EXIST_EMAIL_FALSE = "邮箱可用";
    public static final String EXIST_USERNAME_FALSE = "用户名可用";
    public static final String EXIST_FALSE = "用户名和邮箱可用";
    ...
    public static final String EXIST_EMAIL_TRUE = "邮箱已存在，用户名不存在";
    public static final String EXIST_USERNAME_TRUE = "用户名已存在";
    public static final String EXIST_EMAIL_AND_USERNAME_TRUE = "用户名及邮箱都已存在";
